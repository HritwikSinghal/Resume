...
import type {Blog} from '../../data/dataDef';
    ...
    <Section noPadding sectionId={SectionId.Blogs}>
      <div
        ...
        <div className="z-10 w-full max-w-screen-md px-4 lg:px-0">
          <div className="flex flex-col items-center gap-y-6 rounded-xl bg-gray-900/40 p-6 shadow-lg backdrop-blur-xl">
            <div
              ...
              {blogs.map((blog, index) => {
                ...
                return <Blog blog={blog} isActive={isActive} key={`${blog.name}-${index}`} />;
              })}
            </div>
  ...
  <div
    ...
    {image ? (
      <div className="relative h-14 w-14 shrink-0 sm:h-16 sm:w-16">
        ...
        <Image alt="image" className="h-full w-full rounded-full" placeholder="blur" src={image} />
      </div>
    ) : (
